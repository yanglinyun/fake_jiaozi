...
var exam_item = [['101-综合素质 (幼儿园)','102-保教知识与能力 (幼儿园)'],
...
window.onload = function () {
    ...
    level.onchange = function () {
        ...
        if(value=="初中")
        {
            ...
            score.innerHTML = "";
            exam_item[0].forEach((v,i) => {examArr.push(v);score.innerHTML += (v +`: <input type="text" class="score">
            <br>`)});
            console.log(examArr)
        }
    }
    ...
    subject.onchange = function () {
        var curSub = this.options[this.selectedIndex].value
